...
function updateNumbersOne(event) {
  const x = event.target;
  if (x.classList.contains("numbers")) {
    updateNumbers();
    x.classList.add(`tmpLockedOne`);
    x.classList.remove(`numbers`);
  };
};

function updateNumbersTwo(event) {
  const x = event.target;
  if (x.classList.contains("numbers")) {
    updateNumbers();
    x.classList.add(`tmpLockedTwo`);
    x.classList.remove(`numbers`);
  };
};
